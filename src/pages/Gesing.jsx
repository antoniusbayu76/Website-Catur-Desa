...
const articleThumbnails = [
  {
    title: "Event Gesing",
    desc: "Upacara Adat, Festival Budaya, dan kegiatan masyarakat lainnya.",
    image: thumbnail1,
  },
  {
    title: "Kehidupan Sosial",
    desc: "Masyarakat yang hidup selaras dengan alam dan leluhur.",
    image: thumbnail2,
  },
  {
    title: "Permainan Tradisional",
    desc: "Suara riang anak-anak mewarnai sore hari di lapangan desa.",
    image: thumbnail3,
  },
  {
    title: "Ekonomi dan Pertanian",
    desc: "Pertanian subak, hasil bumi, dan sistem gotong royong.",
    image: thumbnail4,
  },
];

export default function Gesing() {
    ...
    <div className="bg-[#834D3D] text-white font-sans overflow-x-hidden">
      ...
      <section className="relative w-full h-[80vh] overflow-hidden">
        ...
        <div className="relative z-30 flex items-center justify-center h-full">
          <h1 className="text-white text-5xl font-bold">Gesing</h1>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        ...
        >
          <h2 className="text-base sm:text-lg font-semibold leading-snug">
            ...
            <span className="font-bold">Desa Gesing</span> Seperti Fun Fact Ataupun Kedudukan
          </h2>
        </div>
  ...
  <div className="w-full">
    ...
    <p className="text-xs italic text-center text-white/80">Letak Gesing Pada Catur Desa</p>
  </div>
</section>

      {/* DATA DESA - Gambar dan Caption Terpisah */} 
<section className="max-w-6xl mx-auto grid md:grid-cols-2 gap-6 px-4 py-10 items-start">
  ...
  <h2 className="text-2xl sm:text-3xl font-bold whitespace-nowrap text-center">
    Glimpse Of Gesing
  </h2>
  <div className="flex-grow border-t border-white/70 max-w-[300px]" />
</div>
