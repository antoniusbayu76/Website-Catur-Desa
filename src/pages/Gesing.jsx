    ...
    <div className="bg-[#fcfcf6] text-gray-900 font-sans overflow-x-hidden">
      ...
      <section className="max-w-3xl mx-auto px-4 py-10">
        <h2 className="text-xl font-semibold leading-relaxed">
          Bagian Highlight Atau Ringkasan Dari Bagian Paling Penting Atau Menarik Dari Suatu Hal Yang Ada Di Desa Gesing Seperti Fun Fact Ataupun Kedudukan Ataupun Sejarah Desa Gesing
        </h2>
        <div className="mt-6">
      ...
      <section className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 px-4 py-10">
        <div className="md:col-span-2">
          ...
          <p className="text-sm text-gray-700 mt-2">
            Cerita, sejarah atau informasi penting mengenai Desa Gesing dapat dimuat di sini sebagai bagian narasi kebudayaan lokal.
          </p>
          <h4 className="text-md font-semibold mt-6">Sub Judul 2</h4>
          <p className="text-sm text-gray-700 mt-2">
            Misalnya hubungan dengan Danau Tamblingan, tokoh penting, adat istiadat atau filosofi lokal.
          </p>
        </div>
