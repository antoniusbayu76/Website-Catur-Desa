...
const articleThumbnails = [
  {
    title: "Event Gobleg",
    desc: "Upacara adat, budaya, dan perayaan desa.",
    image: thumbnail1,
  },
  {
    title: "Kehidupan Sosial",
    desc: "Tradisi hidup rukun dan spiritualitas warga Gobleg.",
    image: thumbnail2,
  },
  {
    title: "Anak dan Permainan",
    desc: "Kehidupan anak-anak dan permainan lokal.",
    image: thumbnail3,
  },
  {
    title: "Ekonomi dan Alam",
    desc: "Pertanian lokal dan keseimbangan ekologis.",
    image: thumbnail4,
  },
];

export default function Gobleg() {
    ...
    <div className="bg-[#834D3D] text-white font-sans overflow-x-hidden">
      ...
      <section className="relative w-full h-[80vh] overflow-hidden">
        ...
        <div className="relative z-30 flex items-center justify-center h-full">
          <h1 className="text-white text-5xl font-bold">Gobleg</h1>
        </div>
      </section>
      ...
      {/* DESKRIPSI 2 KOLOM */}
      <section className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 px-6 py-10 text-white"
        style={{
          borderRadius: "18px",
    ...
    <p className="text-sm leading-relaxed text-justify">
      ...
      yang tinggi bagi masyarakat.
        ...
        <div className="space-y-6 flex flex-col items-center justify-start">
          ...
          <p className="text-xs text-center text-white/80">Gobleg Pada Catur Desa </p>
        </div>
      </section>
          ...
          <div className="mt-2 text-white text-xs pl-2">
            <p className="leading-snug">
              ...
              <span className="text-[10px] text-gray-200 italic">
                Source: Dokumentasi Pribadi Gobleg
              </span>
            </p>
          </div>
        </div>
      ...
      >
        <div className="flex items-center gap-4 mb-8 justify-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold whitespace-nowrap text-center">Glimpse Of Gobleg</h2>
          <div className="flex-grow border-t border-white/70 max-w-[300px]" />
        </div>
