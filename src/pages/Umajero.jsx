...
const articleThumbnails = [
  {
    title: "Event Umajero",
    desc: "Kegiatan spiritual, budaya, dan tradisi masyarakat Umajero.",
    image: thumbnail1,
  },
  {
    title: "Kearifan Lokal",
    desc: "Hidup berdampingan dengan alam dan nilai leluhur.",
    image: thumbnail2,
  },
  {
    title: "Aktivitas Komunitas",
    desc: "Permainan rakyat dan gotong royong desa.",
    image: thumbnail3,
  },
  {
    title: "Pertanian Adat",
    desc: "Subak Umajero dan ekonomi mandiri masyarakat.",
    image: thumbnail4,
  },
];
    ...
    <div className="bg-[#834D3D] text-white font-sans overflow-x-hidden">
      ...
      <section className="relative w-full h-[80vh] overflow-hidden">
        ...
        <div className="relative z-30 flex items-center justify-center h-full">
          <h1 className="text-white text-5xl font-bold">Umejero</h1>
        </div>
      </section>
      ...
      <section className="max-w-4xl mx-auto px-4 py-10">
        ...
        >
          <h2 className="text-base sm:text-lg font-semibold leading-snug">
            ...
            <span className="font-bold">Desa Umajero</span> Seperti Fun Fact Ataupun Kedudukan
          </h2>
        </div>

        <div className="mt-6 rounded-xl overflow-hidden shadow-lg max-w-2xl mx-auto">
          <img src={thumbnail1} alt="Highlight" className="w-full h-64 object-cover" />
        </div>
      ...
      {/* DESKRIPSI */}
      <section className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 px-6 py-10 mt-6 text-white"
        style={{
          borderRadius: "18px",
          backgroundColor: "rgba(243, 145, 65, 0.20)",
        ...
        <div className="md:col-span-2">
          ...
          <p className="text-sm leading-relaxed mb-6 text-justify">
            ...
            yang tinggi bagi masyarakat adat Umajero, karena dipercaya sebagai tempat suci
        ...
        <div className="space-y-6 flex flex-col items-center justify-start">
          ...
          <p className="text-xs italic text-center text-white/80">Letak Umejero Pada Catur Desa</p>
        </div>
      </section>
      ...
      <section className="max-w-6xl mx-auto grid md:grid-cols-2 gap-6 px-4 py-10 items-start">
        <div className="flex flex-col rounded-xl overflow-hidden">
          <div className="rounded-xl overflow-hidden shadow-md">
            <img src={thumbnail1} alt="Gambar Tambahan" className="w-full h-64 object-cover" />
          </div>
          <div className="mt-2 text-white text-xs pl-2">
            <p className="leading-snug">
              ...
              <span className="text-[10px] text-gray-200 italic">
                Source: Dokumentasi Pribadi Umajero
              </span>
            </p>
          </div>
        </div>
        <div className="bg-white shadow-md rounded-xl p-6 text-black">
          ...
          <ul className="text-sm space-y-1">
            ...
            <li>Mayoritas Pekerjaan: XXXX</li>
            <li>Other: XXXX</li>
            <li>Other: XXXX</li>
            <li>Other: XXXX</li>
          </ul>
      ...
      >
        <div className="flex items-center gap-4 mb-8 justify-center">
          ...
          <h2 className="text-2xl sm:text-3xl font-bold whitespace-nowrap text-center">Glimpse Of Umejero</h2>
          <div className="flex-grow border-t border-white/70 max-w-[300px]" />
        </div>
