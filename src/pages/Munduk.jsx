    ...
    <div className="bg-[#fcfcf6] text-gray-900 font-sans overflow-x-hidden">
      ...
      <section className="max-w-3xl mx-auto px-4 py-10">
        <h2 className="text-xl font-semibold leading-relaxed">
          Bagian Highlight Atau Ringkasan Dari Bagian Paling Penting Atau Menarik Dari Suatu Hal Yang Ada Di Desa Munduk Seperti Fun Fact Ataupun Kedudukan Ataupun Sejarah Desa Munduk
        </h2>
        <div className="mt-6">
      ...
      <section className="max-w-6xl mx-auto grid md:grid-cols-3 gap-8 px-4 py-10">
        <div className="md:col-span-2">
          ...
          <p className="text-sm text-gray-700 mt-2">
            Alas Mertajati adalah hutan adat yang terletak di kawasan Danau Tamblingan, Kecamatan Banjar, Kabupaten Buleleng, Bali...
          </p>
